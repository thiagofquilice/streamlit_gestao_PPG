...
from provider import list_dissertations, remove_dissertation, upsert_dissertation
...
records = list_dissertations(ppg_id)
if records:
...
if can(role, "manage_dissertations"):
    ...
    if submitted and titulo and autor:
        upsert_dissertation(ppg_id, titulo, autor, orientador, defesa_prevista.isoformat())
